...
public final class AndroidDateTimeFormatter {
     ...
     * using these styles, a {@link org.threeten.bp.ZoneId} must be available, either by using {@link
     * org.threeten.bp.ZonedDateTime} or {@link DateTimeFormatter#withZone}.
     *
     * @param context the context with which the 12-/24-hour preference and the primary locale are determined.
        ...
        if (timeStyle == FormatStyle.SHORT) {
            ...
            if (pattern == null) {
                ...
                return new DateTimeFormatterBuilder()
                        ...
                        // Match org.threeten.bp's ofLocalizedTime, which also hard-codes IsoChronology:
     ...
     * converted. It has no override zone and uses the {@link org.threeten.bp.format.ResolverStyle#SMART SMART} resolver
     * style.
     *
        ...
        if (timePattern != null) {
            ...
            if (!timePattern.equals(defaultTimePattern) && defaultDateTimePattern.contains(defaultTimePattern)) {
                ...
                return new DateTimeFormatterBuilder()
                        ...
                        .toFormatter(contextPrimaryLocale)
                        // Match org.threeten.bp's ofLocalizedDateTime, which also hard-codes IsoChronology:
                        .withChronology(IsoChronology.INSTANCE);
            }
        }
        return null;
