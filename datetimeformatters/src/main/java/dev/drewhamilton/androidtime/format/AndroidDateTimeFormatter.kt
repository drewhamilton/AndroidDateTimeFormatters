...
object AndroidDateTimeFormatter {
    ...
    @JvmStatic fun ofLocalizedTime(
        ...
        val systemTimeSettingAwarePattern = getSystemTimeSettingAwareTimePattern(
            context = context,
            locale = locale,
            style = timeStyle,
        )
    ...
    @JvmStatic fun ofLocalizedDateTime(
        ...
        val systemTimeSettingAwarePattern = getSystemTimeSettingAwareDateTimePattern(
            context = context,
            locale = locale,
            dateStyle = dateStyle,
            timeStyle = timeStyle,
    ...
    @JvmStatic private fun DateTimePatternGenerator.getBestPatternFor24Setting(
        ...
        return locale.getCompatibleEnglishPattern(
            pattern = getBestPattern(skeletonFor24Setting),
        )
    }
