...
11. `startship release -u personalSonatypeIssuesUsername -p personalSonatypeIssuesPassword -c dev.drewhamilton.androidtime:datetimeformatters,datetimeformatters-threetenbp:x.y.z`
